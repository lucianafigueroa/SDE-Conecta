...
      Alert.alert("Error", "Ocurrió un error al guardar tu perfil. Asegúrate de que las reglas de Firebase Storage permitan escribir si intentaste subir una foto.");
    } finally {
      setIsLoading(false);
    }
  };
...
        </TouchableOpacity>
        <Button
          title={isLoading ? "Guardando..." : (tipoUsuario === "cliente" ? "Buscar Profesionales" : "Ser Profesional")}
