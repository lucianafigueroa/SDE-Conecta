...
  // Función para manejar el CIERRE DE SESIÓN real con Firebase
  const handleLogout = async () => {
    setModalVisible(false);

    try {
      await signOut(auth); // Lógica de Firebase para cerrar sesión
      console.log('Sesión cerrada con éxito.');

      // Redirige a la pantalla de inicio y borra el historial de navegación
      navigation.reset({
        index: 0,
